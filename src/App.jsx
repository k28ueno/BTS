              ...
              <div className="bg-white border-2 rounded-xl p-6 shadow-sm">
                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {[
                      ...
                      ['エントリー管理', '登録されている全エントリーの一覧確認・編集・削除を行います。「Excelエクスポート」で全件をExcel（.xlsx）にダウンロードでき、「Excelインポート」でExcelファイルから一括登録・更新できます。インポート時は列見出しの表記ゆれ・並び順の違いを自動判定したうえで「列の対応確認」画面が開くので、対応がおかしければプルダウンで修正してから反映できます。'],
              ...
              <div className="bg-white border-2 rounded-xl p-6 shadow-sm">
                 ...
                 <div className="space-y-3">
                    {[
                      ...
                      ['エントリーをExcelで一括登録・更新したい', 'エントリー管理画面の「Excelインポート」からファイルを選択すると、列見出しを自動判定した「列の対応確認」画面が開きます。対応が誤っていればプルダウンで選び直し、「次へ」で内容を確認してから反映します。ID列が既存エントリーと一致する行は更新、空欄の行は新規登録になります。'],
